...
PANORAMA_OPENEDX_BACKEND_VERSION = '16.0.3'
...
PANORAMA_MFE_VERSION = 'open-release/palm.20240605'
...
def panorama_extract_and_load(all_, tables, force) -> list[tuple[str, str]]:
    """
...
hooks.Filters.CLI_DO_COMMANDS.add_item(panorama_extract_and_load)
